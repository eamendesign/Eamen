...
public:
	...
	Vector3	GetPreviousPosition() { return p_position; }
	...
	void SetBeginNode(float x) {beginNode = x; }
	void SetEndNode(float x) {endNode = x; }

	float GetBeginNode() {return beginNode;}
	float GetEndNode() {return endNode;}
